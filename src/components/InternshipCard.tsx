...
const InternshipCard = () => {
  const openMail = () => {
    window.open('mailto:anugragupta07@gmail.com', '_blank');
  };
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              AI Efficiency Specialist Application
            </p>
          </div>
        </div>
      ...
      <div className="mt-8">
        ...
        <p className="text-foreground text-sm">
          Join innovative teams building AI-powered efficiency systems that make a real impact. I want to leverage my expertise in workflow automation, AI agentic systems, and sustainable tech to create solutions that save time, multiply outcomes, and deliver measurable ROI.
        </p>
      </div>
