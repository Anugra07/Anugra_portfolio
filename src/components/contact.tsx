...
export function Contact() {
  ...
  const contactInfo = {
    ...
    socials: [
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/anugra-gupta/',
      },
      {
        name: 'Youtube',
        url: 'https://www.youtube.com/@anugra07',
      },
      {
        name: 'Instagram',
        url: 'https://www.instagram.com/anugra07/',
      },
      {
        name: 'Discord',
        url: 'https://discord.com/users/anugra07',
      },
      {
        name: 'Github',
        url: 'https://github.com/Anugra07',
      },
    ],
  };
